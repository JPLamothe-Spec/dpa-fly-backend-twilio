...
// Simple health check for Fly smoke checks
...
wss.on("connection", (twilioWS, req) => {
  ...
  oaiWS.on("open", () => {
    ...
    // Short greeting so caller hears something right away
    oaiWS.send(JSON.stringify({
  ...
  twilioWS.on("close", cleanup); oaiWS.on("close", cleanup);
});
